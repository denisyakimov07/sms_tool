...
def start():
    ...
    scheduler.add_job(daily_report, trigger='cron', hour="14", minute='30', id="Sent_daily_report" , replace_existing=True)
    scheduler.add_job(sent_sms, trigger='cron', hour="16", minute='54', id="Sent_sms", replace_existing=True)
    scheduler.start()