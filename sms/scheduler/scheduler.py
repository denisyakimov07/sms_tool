...
def start():
    ...
    scheduler.add_job(update_app, trigger='cron', hour="14", minute='13', id="Update_acuityscheduling_appointments" , replace_existing=True)
    scheduler.add_job(daily_report, trigger='cron', hour="14", minute="14", id="Sent_daily_report" , replace_existing=True)
